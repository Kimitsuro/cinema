 ...
 */
final class Version20250531140812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_3d5c3666700047d2
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE seat DROP ticket_id
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE seat ADD ticket_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
